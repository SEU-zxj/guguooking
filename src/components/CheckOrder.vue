        ...
        <el-container>
          <el-main class="ordermain">
            ...
            <div 
              ...
              style="margin-top: 7%;"
            >
              <el-empty description=" " :image="require('@/assets/orderEmpty.png')" image-size="200">
                <el-text>
                <el-text style="color: #000000;font-size: x-large;" tag="b">个人行程将在此显示</el-text><br><br>
                <el-text size="large" style="color: #000000;">本页将显示您的所有订单。如果您有订单，但本页没有显示，可使用订单确认号和PIN码导入订单。</el-text>
              </el-text>
              </el-empty>
            </div>
                ...
                <el-card shadow="hover" class="orderCard">
                  <el-row :gutter="0">
                    ...
                    <el-col :span="3" :offset="21">
                      ...
                      ><el-button 
                        style="position: absolute;top:0; right:0;bottom:0;margin:auto;width: 50px;height: 50px;"
                        @click="removeOrder(index)"
                        >
                        <el-image style="width: 25px;vertical-align: middle;" :src="require('@/assets/order/delete.svg')"/>
                      </el-button>
                      </el-tooltip>
                    </el-col>
                  </el-row>
                  <el-row :gutter="20" style="margin-bottom: -5px;">
                    <el-col :span="6">
                      <el-image 
                        src="https://img2.selfimg.com.cn/uedvoguecms/2020/08/18/1597736016_EEzaSy.jpg"
                        :fit="contain"
                    ...
                    <el-col :span="18">
                      ...
                      >
                        <el-col :span="5" style="border-right: solid 1px var(--el-border-color);border-radius: 0%;">
                          ...
                          <el-text style="color: #000000;font-size: xx-large;" tag="b">12</el-text><br>
                          <el-text tag="b" style="color: #000000;font-size: large;">5月</el-text><br>
                        ...
                        <el-col :span="5" style="border-right: solid 1px var(--el-border-color);border-radius: 0%;">
                          ...
                          <el-text style="color: #000000;font-size: xx-large;" tag="b">14</el-text><br>
                          <el-text tag="b" style="color: #000000;font-size: large;">5月</el-text><br>
                          <el-image style="width: 16px;vertical-align: middle;" :src="require('@/assets/order/time.svg')"/>
                          <el-text>07:00至11:00</el-text>
                        </el-col>
                        <el-col :span="6" style="border-right: solid 1px var(--el-border-color);border-radius: 0%;">
                          <el-row>
                            <el-col :span="11">
                            <el-text>客房数</el-text><br>
                            <el-text style="color: #000000;font-size: xx-large;" tag="b">1</el-text>
                          </el-col>
                          <el-col :span="2"><br><el-text style="font-size: xx-large;">/</el-text></el-col>
                          <el-col :span="11">
                            <el-text>入住夜数</el-text><br>
                            <el-text style="color: #000000;font-size: xx-large;" tag="b">2</el-text>
                          </el-col>
                          </el-row>
                        </el-col>
                        <el-col :span="8">
                          <el-text>总价(含所有费用)</el-text><br><el-text>约&nbsp;&nbsp;</el-text>
                          <el-text style="color: #000000;font-size: xx-large;" tag="b">{{ order.totalPrice + "元"}}</el-text><br>
                        </el-col>
                      </el-row>
                      <el-row>
                        <el-col :span="24"><el-button style="height: 40px;vertical-align: middle;position: absolute;top:0; left:0; right:0;bottom:0;margin:auto;">
                         <el-image style="width: 25px; height: 25px" :src="require('@/assets/menu_icon/my_icon/order.svg')"/>
                          <el-text style="font-size:medium;"> &nbsp;&nbsp;查看行程和订单详情</el-text>
                        </el-button></el-col>
                      </el-row>
                    </el-col>
                  </el-row>
          ...
          <el-footer>
            <el-row :gutter="0">
              <el-col :span="1">
                <el-image style="width: 45px;" :src="require('@/assets/phoneFilled_yellow.svg')" :fit="fit" />
              </el-col>
